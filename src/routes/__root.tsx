...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shanti Shawls Emporium — Timeless Kashmiri Elegance" },
      { name: "description", content: "Heritage Kashmiri pashmina, kani and sozni shawls hand-woven by master artisans. Trusted since 1974." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "Heritage Kashmiri shawl and clothing store, trusted since 1974.",
          foundingDate: "1974",
        }),
      },
    ],
